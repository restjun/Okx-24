...
def check_final_warning(
    ...
    warning = check_breakout_warning(
        df15m,
        df1h,
        df4h,
        column
...
def alignment_html(
    ...
    if alignment == "long_alignment":
        ...
        return """
        <span class="alignment-signal long-alignment">
            LONG
        </span>
        """
    ...
    if alignment == "short_alignment":
        ...
        return """
        <span class="alignment-signal short-alignment">
            SHORT
        </span>
        """
...
def update_dashboard():
    ...
    logging.info(
        "〽️ LONG : "
        "전체 정배열이지만 "
        "15M 20-60-120만 정배열 아님"
    )

    logging.info(
        "〽️ SHORT : "
        "전체 역배열이지만 "
        "15M 20-60-120만 역배열 아님"
    )
