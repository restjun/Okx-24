...
#
# 빨강 = 현재 하락 카운트
# 회색 = 상승 전환으로 최종 확정된 카운트
#
# ▲ 표시 없음
# =========================================================

def close_ema10_html(
    data
):
...
<div class="info">
    ...
    ④ 10선 아래 종가 → ▼(1)부터 빨간색 카운팅<br>

    ⑤ 계속 10선 아래 종가 → ▼(2), ▼(3)...<br>

    ⑥ 10선 위 상승 종가 → 기존 ▼(N) 회색 고정<br>

    ⑦ 상승 전환 후에도 최종 ▼(N) 삭제 안 함<br>
