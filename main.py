...
#
# 3. 최초 음봉 발생
#    → 그 음봉의 저점을 손절 기준으로 저장
#
# 4. 이후 캔들의 저가가
#    최초 음봉 저점 아래로 내려가면
#    → ⛔️
#
# 5. 기존 돌파 기준 저점의 종가 이탈도
#    → ⛔️ 유지
#
#
# SHORT
...
#
# 3. 최초 양봉 발생
#    → 그 양봉의 고점을 손절 기준으로 저장
#
# 4. 이후 캔들의 고가가
#    최초 양봉 고점 위로 올라가면
#    → ⛔️
#
# 5. 기존 돌파 기준 고점의 종가 이탈도
#    → ⛔️ 유지
# =========================================================
...
def get_breakout_tracking(
    ...
    first_bearish_low = None

    first_bullish_high = None
    ...
    for index in range(
        ...
        if breakout_direction == "long":
            ...
            if first_bearish_low is None:

                if close < open_price:

                    first_bearish_low = low
        ...
        # =================================================
            ...
            if first_bullish_high is None:

                if close > open_price:

                    first_bullish_high = high
...
※ 🚀(2) = 돌파 후 첫 추가 고점/저점 갱신<br>

※ 🚀(3) = 돌파 후 두 번째 추가 고점/저점 갱신<br>

※ LONG = 고점 갱신 + 상승 마감 기준<br>

※ SHORT = 저점 갱신 + 하락 마감 기준<br>

※ LONG ⛔️ = 돌파 기준 저점 종가 이탈 또는 최초 음봉 저점 이탈 시 중지<br>

※ SHORT ⛔️ = 돌파 기준 고점 종가 이탈 또는 최초 양봉 고점 이탈 시 중지<br>
