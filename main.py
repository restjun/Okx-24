...
def dashboard():
    ...
    <body>
        ...
        <div class="info">
            ...
            ④ 4H EMA3 &gt; EMA10 연속 카운팅 → 🟢(N)<br>

            ⑤ EMA3와 EMA10은 모두 4H 캔들 종가 기준<br>

            ⑥ 모든 조건 충족 즉시 → 🛩✈️<br>

            ⑦ 4H EMA3 &gt; EMA10 유지 → 새 확정 캔들마다 비행기 카운트 +1<br>

            ⑧ 양봉/음봉 관계없이 카운트 증가<br>

            ⑨ 4H EMA3 &lt; EMA10 역배열 종가 확정 시 → ⛔️ 종료<br>
