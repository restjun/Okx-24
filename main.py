...
def get_upbit_okx_top10():
    ...
    okx_coin_set = get_okx_swap_coin_set()
    ...
    for market, volume in volume_map.items():
        ...
        if coin in okx_coin_set:


            filtered[market] = volume
