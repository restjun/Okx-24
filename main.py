...
# =========================
# 1H RSI/MFI 돌파 확인 (임계값 70, 3기간)
# =========================

def check_1h_mfi_rsi_cross(inst_id, period=3, threshold=70):
    df = get_ohlcv_okx(inst_id, bar='1H', limit=500)
...
def send_new_entry_message(all_ids):
    ...
    # === 당일 신규 1H 돌파 코인 확인 ===
    for inst_id in top_ids:
        is_cross, cross_time = check_1h_mfi_rsi_cross(inst_id, period=3, threshold=70)
