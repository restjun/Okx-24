...
# API 하나가 오래 걸려 전체 분석이 멈추는 것을 방지
MAX_RETRIES = 3
...
def analyze(
    ...
    # ★ Upbit는 별도 일봉 API 호출 제거
    # update_upbit()에서 ticker의 등락률을 직접 넣음
    changes = (
