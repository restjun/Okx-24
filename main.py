...
def get_signal_qualified(
    ...
    # ① 정배열
    # ② ROC 양수
    # ③ 돌파 발생 OR ROC 3개 이상 연속
    #
    # 따라서 돌파 직후도 진행 리스트에 들어감
    # =====================================================
