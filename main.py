...
def update_upbit():
    ...
    logging.info(
        f"업비트 전체 {total}개 조회 완료"
    )

    logging.info(
        f"업비트 TOP{TOP_N} EMA 조회 시작"
    )
