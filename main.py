...
def roc_progress_section(
    ...
    <div class="table-wrap focus-progress-table">
...
def dashboard():
    ...
    <head>
        ...
        <title>
            {timeframe_label} EMA30·60·120 · ROC10
        </title>
