...
def check_1h_warning(
    ...
    ema1h_10_20 = get_ema_10_20_direction(
        df1h,
        column1h
    )
...
def get_okx_1h_4h_ema(
    ...
    trend4h = check_4h_trend_condition(
        df4h,
        "c"
    )
...
<p>
1시간 눌림 · 돌파 · 4시간 추세 · EMA 10-20 / 20-60-120
</p>
