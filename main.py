...
def table_section(
    ...
    if focus:
        ...
        title_html = (
            ...
            '🚨 집중 리스트'
            f'<small>{update_time} KST</small>'
            '</h2>'
        )

        table_class = "table-wrap focus-table"

        empty_text = "현재 경고 발생 코인 없음"
