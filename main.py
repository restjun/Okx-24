...
def send_new_entry_message(all_ids):
    ...
    for inst_id in top_100_ids:
        ...
        if pd.isna(d1_mfi) or d1_mfi < 70 or pd.isna(d1_rsi) or d1_rsi < 70:
            continue
        ...
        if not last_status and is_cross:  # 돌파 기준은 여전히 4H
            ...
            new_entry_coins.append(
                (inst_id, daily_change, volume_24h, h4_mfi, h4_rsi, d1_mfi, d1_rsi, coin_rank)
            )
