...
def update_dashboard():
    ...
    if not upbit_ok:
        ...
        logging.warning(
            "업비트 조회 실패 - 다음 1분 주기에 재시도"
        )

    if not okx_ok:

        logging.warning(
            "OKX 조회 실패 - 다음 1분 주기에 재시도"
        )
...
※ 🔴 = EMA10 &lt; EMA30 &lt; EMA60 &lt; EMA120<br>
※ 업비트 거래대금 = 업비트 Ticker의 24시간 누적 거래대금<br>
※ EMA는 1H / 4H만 표시
...
※ OKX 거래대금 = 기존 1H 캔들 거래대금 합산 방식<br>
※ EMA = 1H / 4H
