    ...
    with ema10_state_lock:
        ...
        if close < current_ema10:
            ...
            state["count"] = (
                state["count"] + 1
                if state["count"] > 0
                and state.get("last_position") == "below"
                else 1
            )
...
def close_ema10_html(data):
    ...
    cls = {
        ...
        "above_memory": "close-ema-below",
        "equal_memory": "close-ema-below",
        "above": "close-ema-none",
        "equal": "close-ema-none"
    }.get(
        position,
        "close-ema-none"
    )
